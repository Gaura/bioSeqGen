...
read.fasta('/work-zfs/mschatz1/genomescopeLR/bioSeqGen/data/saureus_genomic.fna') -> ecoliSeq
...
write.table(kmers10kE05X30Df,'/work-zfs/mschatz1/genomescopeLR/output/SAkmers10kE05X30Df.txt',sep = '\t',quote = F,row.names = F)
kmers10kE05X30DfCross <- getCrossConnection(kmers10kE05X30Df)
write.table(kmers10kE05X30DfCross,'/work-zfs/mschatz1/genomescopeLR/output/SAkmers10kE05X30DfCross.txt',sep = '\t',quote = F,row.names = F)