...
getKmers
```{r}
kmers10kWith5pcentError <- sapply(1:length(reads10kWith5PcentError),function(x) getKmersFromRead(reads10kWith5PcentError[x]))
beepr::beep(8)
kmers10kWith5pcentError <- unlist(kmers10kWith5pcentError) #Unlist kmers
#get Table
kmers10kWith5pcentErrorTable <- table(kmers10kWith5pcentError) 
#get Df
kmers10kWith5pcentErrorDf <- as.data.frame(kmers10kWith5pcentErrorTable)
```
